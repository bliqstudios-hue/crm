...
describe("mondayIndex", () => {
  it("maps Monday → 0 and Sunday → 6", () => {
    // Local constructor (not a date-only ISO string) — ISO date-only
    // strings parse as UTC midnight, which getDay() (local-timezone)
    // can roll back to the previous day depending on the machine's TZ.
